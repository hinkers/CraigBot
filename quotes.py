...
ferengi_rules_of_acquisition = [
    ...
    "Rule 6: Never allow family to stand in the way of opportunity. [1]",
    "Rule 7: Keep your ears open.",
    "Rule 8: Small print leads to large risk. [2]",
    "Rule 9: Opportunity plus instinct equals profit.",
    "Rule 10: Greed is eternal.",
    "Rule 16: A deal is a deal. [3]",
    "Rule 17: A contract is a contract is a contract… but only between Ferengi. [4]",
    ...
    "Rule 31: Never make fun of a Ferengi's mother. [5]",
    "Rule 33: It never hurts to suck up to the boss. [6]",
    "Rule 34: War is good for business. [7]",
    "Rule 35: Peace is good for business. [8]",
    "Rule 45: Expand or die. [9]",
    ...
    "Rule 194: It's always good business to know about new customers before they walk in your door. [11]",
    ...
    "Rule 223: Unknown, but presumably concerned the relationship between \"keeping busy\" and \"being successful\".",
    "Rule 229: Latinum lasts longer than lust.",
    "Rule 239: Never be afraid to mislabel a product. [12]",
